...
def get_model(num_classes=6, conv_filters=128, rnn_size = 128, drop = 1.0, rnn_drop = 0.0, rnn = "GRU"):             
    embed_size = 128
...
# Get a model
model = get_model(rnn_drop=0.3, rnn="LSTM")
batch_size = 512
epochs = 1
